...
//        File dirfile = new File(FileHelper.getAppFilesPath() + File.separator +"apks"+File.separator ,INSTALL_APK_NAME);
//        if (!dirfile.exists()) {
//            dirfile.mkdirs();
//        }
...
//        Uri uri= FileProvider.getUriForFile(MyApplication.getInstance(),"com.paulz.hhb.fileprovider",file);
