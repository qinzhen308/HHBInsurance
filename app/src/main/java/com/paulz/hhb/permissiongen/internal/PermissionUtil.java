package com.paulz.hhb.permissiongen.internal;
...
import com.paulz.hhb.permissiongen.PermissionFail;
import com.paulz.hhb.permissiongen.PermissionRationale;
import com.paulz.hhb.permissiongen.PermissionSuccess;

final public class PermissionUtil {
  public final static int Build_VERSION_CODES_M = 23;
  ...
  @TargetApi(value = Build_VERSION_CODES_M)
