...
import com.paulz.hhb.adapter.SalesmanAdapter;
import com.paulz.hhb.adapter.TeamAdapter;
...
import com.paulz.hhb.model.wrapper.SalesmanWraper;
import com.paulz.hhb.model.wrapper.TeamWraper;
...
public class SalesmanListActivity extends BaseListActivity implements PullToRefreshBase.OnRefreshListener, LoadStateController.OnLoadErrorListener {
        ...
        searchBar.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    onRefresh();
                    AppUtil.hideSoftInputMethod(SalesmanListActivity.this, searchBar);
                    return true;
                }
                return false;
            }
    ...
    private void initData(boolean isRefresh) {
        ...
        if (isRefresh) {
            immediateLoadData(APIUtil.parseGetUrlHasMethod(params.getParamList(), AppUrls.getInstance().URL_SALESMAN_LIST), SalesmanWraper.class);
        } else {
            reLoadData(APIUtil.parseGetUrlHasMethod(params.getParamList(), AppUrls.getInstance().URL_SALESMAN_LIST), SalesmanWraper.class);
        }
    }
    ...
    public static void invoke(Activity context) {
        Intent intent = new Intent(context, SalesmanListActivity.class);
