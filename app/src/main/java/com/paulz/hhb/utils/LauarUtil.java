...
//    private static String[] monthNong = {"正", "正", "二", "三", "四", "五", "六","七", "八", "九", "十", "十一", "十二"};
    private static String[] monthNong = {"正月","正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","冬月","腊月"};
    ...
    public static String[] getLunarMD(String year, String month, String day){
    	Date sDObj;
        String s;
        int SY, SM, SD;
        int sy;
        ...
        //日期  
        Lunar1(sDObj); //农历  
    	return new String[]{(getIsLeap() ? "闰" : "")+monthNong[getMonth()],cDay(getDay())};
    }
    ...
    public static String getLunarDay(String year, String month, String day){
        ...
        Lunar1(sDObj); //农历  
        if(getDay()==1){
        	return (getIsLeap() ? "闰" : "")+monthNong[getMonth()];
        }else {
			return cDay(getDay());
		}
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getLunar("2000", "6", "8"));
        System.out.println(getLunar("2009", "4", "3"));
        System.out.println(getLunar("2017", "7", "22"));
        System.out.println(Arrays.toString(getLunarMD("2016", "3", "1")));
        System.out.println(Arrays.toString(getLunarMD("2017", "7", "23")));
        System.out.println(Arrays.toString(getLunarMD("2017", "8", "22")));
        
        System.out.println(getLunarDay("2016", "3", "1"));
        System.out.println(getLunarDay("2017", "7", "23"));
        System.out.println(getLunarDay("2017", "8", "22"));
        
        System.out.println(getLunarDay(new Date()));
