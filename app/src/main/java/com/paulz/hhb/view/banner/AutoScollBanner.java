...
import com.paulz.hhb.listener.BannerOnClickListener;
import com.paulz.hhb.model.Banner;
import com.paulz.hhb.model.Information;
...
//			view.setOnClickListener(new BannerOnClickListener(mContext, banner));
			Image13Loader.getInstance().loadNoStubImageFade(AppUrls.getInstance().BASE_DOMAIN+banner.imgurl, view);
		}
