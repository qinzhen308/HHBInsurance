...
public class HotSearchLayout extends ViewGroup {
	...
	public HotSearchLayout(Context context, AttributeSet attrs, int defStyle) {
			...
			child.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(mOnItemClick!=null){
						mOnItemClick.onItemClick(child, position);
					}
				}
			});
			// 测量子View的宽和高
