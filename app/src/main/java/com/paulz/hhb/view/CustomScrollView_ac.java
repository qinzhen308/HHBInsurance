 ...
 * 
 */
public class CustomScrollView_ac extends ScrollView {
	...
	public CustomScrollView_ac(Context context) {
		super(context);
	}

	public CustomScrollView_ac(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
