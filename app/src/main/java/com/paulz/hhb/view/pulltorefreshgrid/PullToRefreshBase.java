 ...
 *******************************************************************************/
package com.paulz.hhb.view.pulltorefreshgrid;
...
import com.paulz.hhb.view.pulltorefresh.PullToRefreshAdapterViewBase;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * @return Either {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#REFRESHING} or {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 *
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#RESET} state.
	 */
	...
	private void init(Context context, AttributeSet attrs) {
        ...
        // isShowHeader = a.getBoolean(R.styleable.PullToRefresh_waterpullshowheader, true);
	...
	public static enum AnimationStyle {
		 ...
		 * int.
		 *
		 * @param modeInt - int to mMessageContactsMap a Mode to
	...
	public static enum Mode {
		 ...
		 * {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.tuan800.tao800.components.scrollerGridView.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
	...
	public static enum State {
		 ...
		 * 
		 * @param stateInt - int to mMessageContactsMap a State to
